...
This project aim to learn how to setup full-stack web app with react and rails.

[Click here](https://github.com/hienphan0111/hello-rails-back-end) to access app's back end
...
```bash
git clone https://github.com/hienphan/hello-react-front-end.git
```
